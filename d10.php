...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">Program Literasi Digital Anak Desa</h1>
        <p class="lead text-white">Mari berdonasi untuk Program Literasi Digital Anak Desa. Donasi Anda akan membantu menyediakan akses ke teknologi, pelatihan, dan sumber daya digital bagi anak-anak di desa. Bersama, kita bisa membuka peluang baru dan membekali mereka dengan keterampilan untuk masa depan. Donasi sekarang dan dukung pendidikan digital mereka!
        </p>
      </div>


      <div class="ftco-cover-1 overlay" style="background-image: url('images/libhd.png');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            <form id="donation-form" action="proses_d10.php" method="post">
