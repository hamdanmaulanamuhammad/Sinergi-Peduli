...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <header class="site-navbar site-navbar-target bg-secondary shadow" role="banner">
      ...
      <div class="container">
        <div class="row align-items-center position-relative">
          ...
          <div class="site-logo">
            <a href="index.pphp" class="text-white">SinergiPeduli</a>
          </div>


          <nav class="site-navigation text-left ml-auto " role="navigation">
            <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
              <li><a href="index.pphp" class="nav-link">Home</a></li>
              <li><a href="about.pphp" class="nav-link">About Us</a></li>
              <li><a href="causes.pphp" class="nav-link">Our Causes</a></li>
              <li><a href="contact.pphp" class="nav-link">Contact</a></li>
              <li><a href="profile.pphp" class="nav-link">Volunteer</a></li>
            </ul>
          </nav>
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">Bantuan Pengobatan Penderita Kanker</h1>
        <p class="lead text-white">Mari berdonasi untuk bantuan pengobatan penderita kanker. Donasi Anda akan memberikan bantuan vital seperti biaya pengobatan, perawatan medis, dan dukungan psikologis kepada penderita kanker dan keluarga mereka. Bersama-sama, kita dapat memberikan harapan dan kehidupan yang lebih baik bagi mereka yang sedang berjuang melawan penyakit ini. Donasi sekarang dan bantu mereka dalam perjalanan kesembuhan mereka!
        </p>
      </div>


      <div class="ftco-cover-1 overlay" style="background-image: url('images/kan.png');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            <form id="donation-form" action="proses_d8.php" method="post">
            ...
            <div class="row">
              ...
              <div class="col-md-4 ml-auto">
                ...
                <ul class="list-unstyled">
                  <li><a href="about.pphp">About Us</a></li>
                  <li><a href="contact.pphp">Contact Us</a></li>
                </ul>
              </div>
