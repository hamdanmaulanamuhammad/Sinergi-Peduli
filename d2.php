...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">Bantu Pendidikan dan Gizi Anak Kurang Mampu</h1>
        <p class="lead text-white">Dengan donasi Anda, kita bisa memberikan pendidikan dan gizi terbaik bagi anak-anak kurang mampu. Setiap sumbangan adalah langkah kecil yang memiliki dampak besar dalam membentuk masa depan mereka. Mari bersama-sama memberikan mereka harapan dan peluang untuk meraih impian mereka.
        </p>
      </div>


      <div class="ftco-cover-1 overlay" style="background-image: url('images/pen.png');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            <form id="donation-form" action="proses_d2.php" method="post">
