...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">Satukan Solidaritas Bantu Warga Palestina!</h1>
        <p class="lead text-white">Satukan Solidaritas Bantu Warga Palestina!" mengajak kita semua berdonasi untuk membantu warga Palestina yang membutuhkan. Setiap sumbangan, sekecil apapun, dapat menyediakan makanan, obat-obatan, dan tempat tinggal. Mari tunjukkan kepedulian kita dan berikan harapan baru bagi mereka yang terdampak. Donasi sekarang dan buat perbedaan nyata!

        </p>
      </div>


      <div class="ftco-cover-1 overlay" style="background-image: url('images/pls.png');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            <form id="donation-form" action="proses_d3.php" method="post">
