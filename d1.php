...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">Sedekah Bantu Renovasi Panti Asuhan</h1>
        <p class="lead text-white">Dengan sedekah Anda, kita bisa membantu renovasi panti asuhan yang sangat membutuhkan. Setiap sumbangan adalah langkah kecil yang memiliki dampak besar dalam menciptakan lingkungan yang aman dan nyaman bagi anak-anak. Mari bersama-sama memberikan mereka tempat tinggal yang layak dan harapan untuk masa depan yang lebih baik.
        </p>
      </div>


      <div class="ftco-cover-1 overlay" style="background-image: url('images/pantihd.png');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            <form id="donation-form" action="proses_d1.php" method="post">
