...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">All Eyes On Rafah !</h1>
        <p class="lead text-white">"All Eyes On Rafah!" adalah kampanye donasi untuk membantu warga Rafah yang terdampak krisis. Dengan kontribusi Anda, kita bisa menyediakan kebutuhan mendesak seperti makanan, obat-obatan, dan tempat tinggal. Bersama, kita bisa memberikan harapan dan dukungan bagi mereka yang membutuhkan. Mari berdonasi dan buat perbedaan nyata sekarang!

        </p>
      </div>


      <div class="ftco-cover-1 overlay" style="background-image: url('images/rafah.png');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            <form id="donation-form" action="proses_d4.php" method="post">
