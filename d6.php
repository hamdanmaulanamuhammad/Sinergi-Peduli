...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">Bantuan Pendidikan di Daerah Terpencil</h1>
        <p class="lead text-white">Mari berdonasi untuk membantu korban gempa di Sulawesi. Donasi Anda akan menyediakan kebutuhan mendesak seperti makanan, air bersih, obat-obatan, dan tempat tinggal sementara. Bersama-sama, kita bisa menunjukkan kepedulian dan memberikan dukungan bagi mereka yang sedang berjuang. Donasi sekarang dan buat perbedaan nyata!
      ...
      <div class="ftco-cover-1 overlay" style="background-image: url('images/pendb.png');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            <form id="donation-form" action="proses_d6.php" method="post">
