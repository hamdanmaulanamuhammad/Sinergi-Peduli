...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">Bantuan Gizi untuk Balita di Desa</h1>
        <p class="lead text-white">Mari berdonasi untuk bantuan gizi bagi balita di desa. Donasi Anda akan membantu menyediakan makanan bergizi, vitamin, dan pemeriksaan kesehatan bagi balita yang membutuhkan. Bersama, kita bisa meningkatkan kesehatan dan masa depan anak-anak ini. Donasi sekarang dan berikan mereka awal hidup yang lebih baik!
        </p>
      </div>


      <div class="ftco-cover-1 overlay" style="background-image: url('images/giz.png');"></div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            <form id="donation-form" action="proses_d9.php" method="post">
